...
for data_structure in data_structures:
    ...
    MEL_CENTRE_FLOAT_FILE = "mel_centre_frequencies_float_mel_{}_fft_{}_sr_{}.h".format(n_mel, n_fft, sample_rate)
    MEL_CENTRE_NEXT_BIN_FILE = "mel_centre_frequencies_next_bin_mel_{}_fft_{}_sr_{}.h".format(n_mel, n_fft, sample_rate)
    MEL_CENTRE_PREV_BIN_FILE = "mel_centre_frequencies_prev_bin_mel_{}_fft_{}_sr_{}.h".format(n_mel, n_fft, sample_rate)
    MEL_WEIGHTS_FILE = "mel_frequency_weights_mel_{}_fft_{}_sr_{}.h".format(n_mel, n_fft, sample_rate)
...
for data_structure in data_structures:
    ...
    cog.outl("void")
    cog.outl("get_mel_precomputed_values_mel_{}_nfft_{}_sr_{}(".format(n_mel, n_fft, sample_rate))
    ...
    mel_float_str = "{}_MEL_{}_FFT_{}_SR_{}_BUFFER".format(mel_pre_str, n_mel, n_fft, sample_rate)
    ...
    mel_next_str = "{}_MEL_{}_FFT_{}_SR_{}_BUFFER".format(mel_pre_str, n_mel, n_fft, sample_rate)
    cog.outl("    assert_buffer(")
    ...
    mel_prev_str = "{}_MEL_{}_FFT_{}_SR_{}_BUFFER".format(mel_pre_str, n_mel, n_fft, sample_rate)
    cog.outl("    assert_buffer(")
    ...
    mel_weights_str = "{}_MEL_{}_FFT_{}_SR_{}_BUFFER".format(mel_pre_str, n_mel, n_fft, sample_rate)
    cog.outl("    assert_buffer(")
